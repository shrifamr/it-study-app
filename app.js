...
const basmaTricks = [
  ...
  },
  {
    ...
    badge: "تريكة سريعة",
    intro: "لو التحويل مباشر بينهم، متحولش Decimal في النص. Octal بالذات احفظه بطريقة 4-2-1.",
    rules: [
      ["مربع Octal السحري", "أي 3 bits قيمتهم من الشمال: 4 ثم 2 ثم 1. مثال 010 = 0×4 + 1×2 + 0×1 = 2."],
      ["Binary → Octal", "قسم الرقم من اليمين مجموعات 3، وكل مجموعة حوّلها بـ 4-2-1. مثال: 100110₂ = 100 110 = 4 و 6، إذن 46₈."],
      ["Octal → Binary", "كل رقم Octal اكتبه 3 bits. 4 = 100 و 6 = 110، إذن 46₈ = 100110₂."],
      ["لو المجموعة ناقصة", "زود أصفار على الشمال فقط. مثال: 10₂ تبقى 010، و010 = 2، إذن 10₂ = 2₈."],
...
function rebalanceChoices(questions, offset = 0) {
